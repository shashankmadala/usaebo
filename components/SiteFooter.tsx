    ...
    <footer className="text-paper">
      ...
      <div className="bg-navy-950">
        ...
        <div aria-hidden="true" className="mt-14 overflow-hidden">
          <p className="select-none translate-y-[14%] whitespace-nowrap font-heading text-[clamp(4.5rem,15vw,12rem)] font-bold leading-[0.78] tracking-[-0.04em] text-paper/[0.05]">
            USAEBO
          </p>
        </div>
